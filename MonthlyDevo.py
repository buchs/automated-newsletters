...
reDay = re.compile(r'<text:user-field-decl office:value-type="string" office:string-value="[^"]+" text:name="Day"/>')
reDate = re.compile(r'<text:user-field-decl office:value-type="string" office:string-value="[^"]+" text:name="DateRange"/>')
reTime = re.compile(r'<text:user-field-decl office:value-type="string" office:string-value="[^"]+" text:name="Time"/>')
